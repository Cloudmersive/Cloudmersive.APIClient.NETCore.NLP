...
namespace Cloudmersive.APIClient.NETCore.NLP.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SentimentAnalysisRequest :  IEquatable<SentimentAnalysisRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SentimentAnalysisRequest" /> class.
        /// </summary>
        /// <param name="textToAnalyze">Text to analyze.</param>
        public SentimentAnalysisRequest(string textToAnalyze = default(string))
        {
        ...
        {
            return this.Equals(input as SentimentAnalysisRequest);
        }

        /// <summary>
        /// Returns true if SentimentAnalysisRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SentimentAnalysisRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SentimentAnalysisRequest input)
        {
            if (input == null)
                return false;
