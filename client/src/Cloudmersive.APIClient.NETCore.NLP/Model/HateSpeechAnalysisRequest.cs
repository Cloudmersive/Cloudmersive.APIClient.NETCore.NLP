...
namespace Cloudmersive.APIClient.NETCore.NLP.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class HateSpeechAnalysisRequest :  IEquatable<HateSpeechAnalysisRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HateSpeechAnalysisRequest" /> class.
        /// </summary>
        /// <param name="textToAnalyze">Text to analyze.</param>
        public HateSpeechAnalysisRequest(string textToAnalyze = default(string))
        {
        ...
        {
            return this.Equals(input as HateSpeechAnalysisRequest);
        }

        /// <summary>
        /// Returns true if HateSpeechAnalysisRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of HateSpeechAnalysisRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HateSpeechAnalysisRequest input)
        {
            if (input == null)
                return false;
