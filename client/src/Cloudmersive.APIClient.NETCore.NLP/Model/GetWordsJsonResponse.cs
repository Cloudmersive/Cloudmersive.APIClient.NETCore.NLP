...
namespace Cloudmersive.APIClient.NETCore.NLP.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetWordsJsonResponse :  IEquatable<GetWordsJsonResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as GetWordsJsonResponse);
        }

        /// <summary>
        /// Returns true if GetWordsJsonResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetWordsJsonResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetWordsJsonResponse input)
        {
            if (input == null)
                return false;
