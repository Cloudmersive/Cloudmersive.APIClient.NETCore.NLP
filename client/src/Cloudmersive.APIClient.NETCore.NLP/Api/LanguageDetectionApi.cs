...
namespace Cloudmersive.APIClient.NETCore.NLP.Api
{
    ...
    public partial class LanguageDetectionApi : ILanguageDetectionApi
    {
        ...
        /// <returns></returns>
        public LanguageDetectionApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< LanguageDetectionResponse > LanguageDetectionPostWithHttpInfo (string textToDetect)
        {
            ...
            {
                localVarPostBody = Configuration.ApiClient.Serialize(textToDetect); // http body (model) parameter
            }
            else
            {
            ...
            return new ApiResponse<LanguageDetectionResponse>(localVarStatusCode,
                ...
                (LanguageDetectionResponse) Configuration.ApiClient.Deserialize(localVarResponse, typeof(LanguageDetectionResponse)));
        }
